<div class="collection">
	<div class="bookings form">
		<div class="col s10 offset-s1">
			...
			<h5><?php echo __('Agregar reserva'); ?></h5>
			...
			<div class="input-field col s12 m6">
			<?php	echo $this->Form->input('faculty', array('label'=>'Facultad'));?>
			</div>	
			<!-- <div class="input-field col s12 m6">
			...
			<div class="input-field col s12 m6">
			<?php	echo $this->Form->input('status_room',array('label'=>'Estado de salón'));?>
			</div>
			<div class="input-field col s12 m6">
			...
			<?php	echo $this->Form->input('patient_id',array('label'=>'Paciente'));?>
				...
				<div class="input-field col s12 m4">
					<label for="BookingFinishTime" id="BookingFinishTime">Hora de inicio</label>
